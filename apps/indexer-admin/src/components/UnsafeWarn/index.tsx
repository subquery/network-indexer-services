    ...
    <Tooltip
      ...
      title={
        <div>
          ...
          <Typography variant="medium" style={{ color: '#fff' }}>
            In most cases this means the project is making an external API call, you can check the
            source code or ask the developer about what this project is doing. Making agreements or
            plans with unsafe projects is fine, but you can’t hold Indexers accountable for
            inconsistencies in the data that they index (unless the differences are clearly caused
            in malicious indexers)
          </Typography>
        </div>
      }
    >
